...
**배포 주소**(EC2): http://34.237.195.172:8502
...
Streamlit과 FastAPI를 각각의 컨테이너로 분리(docker-compose.yml)하고 depends_on 옵션을 부여하여 실행 순서를 제어했습니다. 네트워크 환경 분리로 인해 발생할 수 있는 내부 통신 에러를 포트 포워딩(8502:8501, 8001:8000)으로 안정적으로 해결했습니다.
...
```
3. 접속
- Frontend: http://34.237.195.172:8502/
